            ...
            <div class="swiper-container relative">
                ...
                <div class="swiper-wrapper">
                    ...
                    <div class="swiper-slide h-fit">
                        <img height="screen" src="/images/dark3.jpg" class="w-full min-h-64 object-cover" alt="image description">
                        <div class="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-center">
                            <h1 class="text-2xl font-semibold text-white">Welcome to Our Cashout</h1>
                            <p class="text-white mt-2">Our platform is a game-changer...</p>
